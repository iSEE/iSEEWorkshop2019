...
Note that in this case, the two panels are independent of each other (i.e., there is no transmission of data points between them).
...
<!-- Give a code chunk that shows how to preconfigure tables with filters -->
