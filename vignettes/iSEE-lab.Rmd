---
title: "Workflow for interactive visualization of SummarizedExperiment objects with iSEE"
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop", "vignettes/img"), "iSEEinterface.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop", "vignettes/img"), "redDimPlot.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop", "vignettes/img"), "colDataPlot.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop", "vignettes/img"), "rowDataPlot.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop", "vignettes/img"), "heatMap.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop", "vignettes/img"), "featAssayPlot.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop", "vignettes/img"), "sampAssayPlot.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop", "vignettes/img"), "rowStatTable.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop", "vignettes/img"), "colStatTable.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop", "vignettes/img"), "colDataPlotDataParams.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop", "vignettes/img"), "colDataPlotVisualParams.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop", "vignettes/img"), "redDimPlotSelectionParams.png"))`
...
|                    |                                                                     |                                        |
|--------------------|:-------------------------------------------------------------------:|----------------------------------------|
| Panel organization | `r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop", "vignettes/img"), "PanelOrganization.png"))` | [Organize panels](#configuration-ui) |
| Diagnostics        | `r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop", "vignettes/img"), "Diagnostics.png"))`       | [Examine panel chart](#transmit-point-selections), [Extract R code](#reproducibility), [Display panel settings](#configuration-ui) |
| Documentation      | `r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop", "vignettes/img"), "Documentation.png"))`     | [Quick tour](#sharing-tours), [Open the vignette](#more-resources) |
| Additional info    | `r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop", "vignettes/img"), "additionalInfo.png"))`    | [About this session](#reproducibility), [About iSEE](#more-resources) |
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop", "vignettes/img"), "ReducedDimensionType.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop", "vignettes/img"), "ColorByColData.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop", "vignettes/img"), "ColorByFeature.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop", "vignettes/img"), "ColorBySample.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop", "vignettes/img"), "ConfigureVisualParameters.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop", "vignettes/img"), "ConfigureDataPlotPanels.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop", "vignettes/img"), "featAssayPlotDataParams.png"))`
...
To demonstrate the feature, we define a Shiny brush in the _Feature assay plot_ panel to select cells with detectable levels of the _CD3E_ gene.
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop", "vignettes/img"), "GraphSelectionLinks.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop", "vignettes/img"), "Zoom.png"))`
...
For simplicity, we demonstrate this feature using a subset of 3 column metadata--namely "Cluster", "total_counts", and "pct_counts_MT"--out of the set of `r ncol(colData(sce))` column metadata computed by the [workflow above](#prepare-scrnaseq-data).
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop", "vignettes/img"), "FilteredTable.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop", "vignettes/img"), "LinkTableToPlot.png"))`
...
Then open the Data parameters box in the custom panel, and select another annotation (or a feature name) to color the points by. 
...
More examples of custom panels can be found at [https://github.com/kevinrue/iSEE_custom](https://github.com/kevinrue/iSEE_custom) and in the [Custom panels vignette](https://bioconductor.org/packages/release/bioc/vignettes/iSEE/inst/doc/custom.html).
...
To see an example of a more complex tour in action, visit [https://marionilab.cruk.cam.ac.uk/iSEE_pbmc4k/](https://marionilab.cruk.cam.ac.uk/iSEE_pbmc4k/).
The code used to create this app and the associated tour is available from [https://github.com/LTLA/iSEE2018/tree/master/tours/pbmc4k](https://github.com/LTLA/iSEE2018/tree/master/tours/pbmc4k).
