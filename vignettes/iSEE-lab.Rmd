...
output:
  BiocStyle::html_document:
    ...
    number_sections: yes
    toc: true
bibliography: "`r file.path(system.file(package='iSEEWorkshop', 'vignettes/bib'), 'iSEE-lab.bib')`"
---
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop", "vignettes/img"), "customPCA.png"))`
...
`r knitr::include_graphics(file.path(system.file(package="iSEEWorkshop", "vignettes/img"), "customMultipleDifferentialExpression.png"))`
