...
* Charlotte Sonesone^[Friedrich Miescher Institute for Biomedical Research and SIB Swiss Institute of Bioinformatics]
...
To demonstrat the feature, we define a Shiny brush in the _Feature assay plot_ panel to select cells with detectable levels of the _CD3E_ gene.
...
![](XXX_RueAlbrecht_iSEE/GraphSelectionLinks.png)
