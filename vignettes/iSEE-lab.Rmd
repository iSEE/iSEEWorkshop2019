...
```{r}
tour <- data.frame(element = c("#Welcome", "#redDimPlot1", "#redDimPlot2", "#Conclusion"), 
                       intro = c("Welcome to this tour!", "This is the first reduced dimension plot", "And here is the second one", "Thank you for taking this tour!"),
